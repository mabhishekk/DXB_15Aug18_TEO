sap.ui.define([
		...
		var PageController = Controller.extend("z_manager_inbox.controller.RewardsApprnDisplay",{
			formatter : formatter,
						...
						MessageBox.success(msg,{
							...
							onClose: function(sAction) {
								if(sAction === sPrint){
									...
									var sPrintPath      = "/sap/opu/odata/sap/ZPR_APPL_SRV/FORM_TO_PDFSet(apptype='RF',appno='" +that._postingId+"',lang='"+lang+"',ndavalue='')/$value";
			...
			_onPRReject:function(sText, that){
				...
				that.getOwnerComponent().getModel().read(sPath,{
					success:function(oData){
						...
						that.getView().getModel("fiService").refresh();
