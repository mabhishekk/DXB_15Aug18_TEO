sap.ui.define([
		...
		var PageController = Controller.extend("z_manager_inbox.controller.creditCardDisplay",{
		...
		// }
			...
			handleReject: function(oEvent) {
				...
				oModel.create("/WF_UIAPPROVALSet", approver,{
					...
					success:function(oData){
						...
						MessageBox.success(msg,{
							...
							onClose: function(sAction) {
								if(sAction === sPrint){
									var lang            = sap.ui.getCore().getConfiguration().getLanguage();
									var sPrintPath      = "/sap/opu/odata/sap/ZPR_APPL_SRV/FORM_TO_PDFSet(apptype='CC',appno='" +that._postingId+"',lang='"+lang+"',ndavalue='')/$value";
									window.open(sPrintPath,true); 
									that.getOwnerComponent().getModel().refresh()
									that.getOwnerComponent().getRouter().navTo("welcome",true);
								}else{
