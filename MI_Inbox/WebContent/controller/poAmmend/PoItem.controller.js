sap.ui.define([
	'jquery.sap.global',
	'z_manager_inbox/controller/poAmmend/BaseController',
	'sap/ui/model/json/JSONModel',
	'sap/m/MessageBox'
], function ($, BaseController, JSONModel, MessageBox) {
	"use strict";

	return BaseController.extend("z_manager_inbox.controller.poAmmend.PoItem", {
		
		onInit: function () {
			var oComponent = this.getOwnerComponent();
			this._router = oComponent.getRouter();
			this._router.getRoute("poItemDetail").attachMatched(this._loadPoDetail, this);
		},
...
//			Handle navigation
			...
			var sPoNum  = this.tempModel.getProperty(sPath).Ebeln
