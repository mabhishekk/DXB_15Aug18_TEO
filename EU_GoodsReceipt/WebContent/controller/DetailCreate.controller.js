sap.ui.define([
		...
		var PageController = Controller.extend("z_usergr.controller.DetailCreate",{
	...
	//Icon tab bar selection 	
		...
		onServiceItemPress: function(oEvent) {
			...
			if (!this.ServiceOrderDialog) {
				this.ServiceOrderDialog = sap.ui.xmlfragment(this.createId("ServiceOrderDetail"),"z_usergr.view.fragment.ServiceOrder",this); 
				this.getView().addDependent(this.ServiceOrderDialog);
				jQuery.sap.syncStyleClass(this.getView().getController().getOwnerComponent().getContentDensityClass(), this.getView(), this.ServiceOrderDialog);
			}
