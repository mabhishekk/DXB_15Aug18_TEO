//sap.ui.controller("userPr.controller.quot_comparision", {
sap.ui.define([ 
	...
	return Controller.extend("userPr.controller.quot_comparision",{
		formatter: formatter,
	onInit: function() {
...
//		this.FnlQr.push(Ebeln);
		...
		if (!this.qcReasnDialog) {
			...
			this.qcReasnDialog = sap.ui.xmlfragment(this.getView().sId,"userPr.view.fragments.confirmDialog",this); 
