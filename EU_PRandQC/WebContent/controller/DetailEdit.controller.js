...
sap.ui.define([ 
		...
		'sap/m/Button',
		'sap/m/Text'
	], function(Controller, History, Device, MessageBox, formatter, Dialog, Button, Text) {

	return Controller.extend("userPr.controller.DetailEdit",{
		formatter : formatter,
		onInit : function() {
...
//											this.cntxt .PreqPrice = ""
			if (!this.prItemDetailDialog) {
				this.prItemDetailDialog = sap.ui.xmlfragment(this.createId("itemDetail"),"userPr.view.fragments.PRItemDetailCommercial",this); 
		...
		onAddpayment : function(oEvent) {
			var othsArr = this.lModel.getProperty("/mainSet/navigtopayment/results");
			othsArr.push({
				"Reason" : ""
			});
...
//												tablObj.Vatvalue = parseFloat(tablObj.Vatvalue).toFixed(2);
							...
							// sap.ui.core.Fragment.byId(fragmentId,"matrnDiscType").getValue();
//											if (tablObj.Vatvalue) {
//												tablObj.Vatvalue = parseFloat(tablObj.Vatvalue);
//											} else {
//												tablObj.Vatvalue = "0.000";
//											}
