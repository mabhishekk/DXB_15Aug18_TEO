sap.ui.define([
		...
		var PageController = Controller.extend("z_master_fi.controller.Petty",{
			formatter : formatter,
			...
			onInit : function() {
				...
				this.getOwnerComponent().getRouter().getRoute("petty").attachPatternMatched(this._onRouteMatched, this);
			...
			_onRouteMatched: function(oEvent) {
				...
				this._sId        = "/pcashheaderSet('"+  oEvent.getParameter("arguments").objectId +  "')";
