sap.ui.define([
		...
		var PageController = Controller.extend("z_master_fi.controller.Credit",{
			 ...
			 */
			onInit : function() {
				this.getOwnerComponent().getRouter().getRoute("credit").attachPatternMatched(this._onRouteMatched, this);
			},
			
			_onRouteMatched: function(oEvent) {
				this.getView().setModel(this.getView().getModel("fiService"));
				this._postingId  = oEvent.getParameter("arguments").objectId;
				this._sId = "/CreditHeaderSet('"+  oEvent.getParameter("arguments").objectId +  "')";
