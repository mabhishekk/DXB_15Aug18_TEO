sap.ui.define( [
	...
	return Controller.extend("zpo_userapp.controller.poEdit", {
		onInit: function() {
...
//		itemsData = this.lModel.getProperty('/mainSet/navigtoitems/results');
	...
	onPOItemaddPress : function(oEvent) {
		if (!this.prCommDialog) {
			this.prCommDialog = sap.ui.xmlfragment(this.createId("itemsFragment"),"zpo_userapp.view.fragments.POItemAdd",this);
...
//		this.cntxt .PreqPrice = ""
		...
		if (!this.prItemDetailDialog) {
			this.prItemDetailDialog = sap.ui.xmlfragment(this.createId("itemDetail"),"zpo_userapp.view.fragments.POItemDetail",this); 
			// to
