sap.ui.define([
		...
		var PageController = Controller.extend("z_inbox.controller.rewardsApprn.RewardsApprnDisplay",{
			formatter : formatter,
			 ...
			 */
			onInit : function() {
				this.getOwnerComponent().getRouter().getRoute("RewardsApprn").attachPatternMatched(this._onRouteMatched, this);
			},
...
//				this.getView().byId("l5approve").setRequired(true);
			},
	...
	//				approver.navigwitowiuser = [];
			...
			handleEdit: function (oEvent) {
				...
				var sPostingNumber = this.rId;
//				this.getRouter().navTo("RewardsApprnEdit",    {id : sPostingNumber,instId : sWiId});
				this.getOwnerComponent().getRouter().navTo("RewardsApprnEdit", {id : sPostingNumber, instId : sWiId });
			},
			...
			handleReject: function () {
				...
				var dialog = new sap.m.Dialog({
					...
					type: 'Message',
					content: [
						new sap.m.Label({ text: this.getResourceBundle().getText("RejectConformation"), labelFor: 'submitDialogTextarea'}),
