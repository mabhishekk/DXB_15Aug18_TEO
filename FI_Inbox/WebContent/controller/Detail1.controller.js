sap.ui.define([ "jquery.sap.global", "z_inbox/controller/BaseController",
		"sap/ui/Device" ], function(jQuery, Controller, Device) {
	"use strict";

	return Controller.extend("z_inbox.controller.Detail1", {
		onInit : function() {
