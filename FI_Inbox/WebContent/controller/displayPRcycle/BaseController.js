sap.ui.define([
	...
	return Controller.extend("z_inbox.controller.displayPRcycle.BaseController", {
		/**
...
//				this.getOwnerComponent().getRouter().navTo(icKey, {id: this.sId});
				...
				var PoNumber = this.sId;
	        	this.getOwnerComponent().getRouter().navTo("GRdisplay", {id : PoNumber, instId : 'Display'});
			}else if(icKey == "IN"){
				var hrefForProductDisplay = oCrossAppNav.toExternal({
