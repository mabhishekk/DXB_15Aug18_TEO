sap.ui.define( [
	...
	return Controller.extend("providenta.fi.rewards.controller.Master", {
		...
		_onRouteMatched: function(oEvent) {
			...
			*/
			...
			if(!Device.system.phone) {
				this.getOwnerComponent().getRouter().navTo("RewardsAppreciationDetailsCreate", {sId: "New"}, true);				
			}
...
//			var sOrderId = oEvent.getSource().getSelectedItem().getBindingContext().getProperty("orderId");
			...
			this.getOwnerComponent().getRouter()
				.navTo("RewardsAppreciationDetailsDisplay", 
						{sId: sPostingNumber},
						!Device.system.phone);
		},
		...
		onAddPettyCash : function (oEvent) {
			...
			this.getOwnerComponent().getRouter()
				.navTo("RewardsAppreciationDetailsCreate", 
					{sId: "New"},
					!Device.system.phone);
		}
	});
